...
open class MainActivity : LocaleAwareAppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // TODO: sessionManager.handleIntent(this, intent, savedInstanceState)
    ...
    override fun onBackPressed() {
        ...
        val sessionsSheetFragment = fragmentManager.findFragmentByTag(SessionsSheetFragment.FRAGMENT_TAG) as SessionsSheetFragment?

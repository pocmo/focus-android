...
object SupportUtils {
    val HELP_URL = "https://support.mozilla.org/kb/what-firefox-focus-android"
    val DEFAULT_BROWSER_URL = "https://support.mozilla.org/kb/set-firefox-focus-default-browser-android"
    val REPORT_SITE_ISSUE_URL = "https://webcompat.com/issues/new?url=%s&label=browser-focus-geckoview"

    val PRIVACY_NOTICE_URL = "https://www.mozilla.org/privacy/firefox-focus/"
    val PRIVACY_NOTICE_KLAR_URL = "https://www.mozilla.org/de/privacy/firefox-klar/"
    ...
    enum class SumoTopic private constructor(
            /** The final path segment for a SUMO URL - see {@see #getSumoURLForTopic}  */
            @field:VisibleForTesting internal val topicStr: String) {
    ...
    fun openDefaultBrowserSumoPage(context: Context) {
        val session = Session(SupportUtils.DEFAULT_BROWSER_URL, Session.Source.MENU)
